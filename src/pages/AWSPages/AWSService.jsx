  ...
  return (
    <Section className="pt-[12rem] -mt-[5.25rem]" crosses crossesOffset="lg:translate-y-[5.25rem]" customPaddings >
      <div className="container relative" ref={parallaxRef}>
        ...
        <h3 className='text-2xl mt-5 mb-2'>Our AWS service offerings include:</h3>
        <div>
          <ul className='pl-4 flex flex-col gap-2 empty-2'>
            <li className='flex gap-2 mt-2 align-center text-xl'><FaArrowRightLong size={16} />AWS Deployment & Management</li>
              <p className='ml-6'>
            ...
            <li className='flex gap-2 mt-2 align-center text-xl'><FaArrowRightLong size={16} />AWS Security</li>
              <p className='ml-6'>
            ...
            <li className='flex gap-2 mt-2 align-center text-xl'><FaArrowRightLong size={16} />AWS Cost Optimization</li>
              <p className='ml-6'>
            ...
            <li className='flex gap-2 mt-2 align-center text-xl'><FaArrowRightLong size={16} />AWS Managed Services</li>
              <p className='ml-6'>
            ...
            <li className='flex gap-2 mt-2 align-center text-xl'><FaArrowRightLong size={16} />AWS Support</li>
              <p className='ml-6'>
            ...
            <li className='flex gap-2 mt-1 align-center text-xl'><FaArrowRightLong size={16} />AWS Migration</li>
